    ...
    <div className='p-5 rounded-md shadow-xl bg-white border border-gray-400'>
       ...
       <p className='text-sm text-gray-500'>2 days ago</p>
        ...
        <div>
            ...
            <p className='text-sm text-gray-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda enim amet impedit velit! Voluptatum quidem mollitia, perferendis iure repudiandae corrupti!</p>
        </div>
      ...
      <div className='flex items-center gap-4
       mt-4'>
        <Button variant="outline" clasName="bg-[#7209b7]">Details</Button>
